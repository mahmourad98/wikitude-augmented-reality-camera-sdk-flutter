...
class ArchitectWidget extends StatefulWidget {
  ...
  void onTouchBegan(int pointer, double x, double y) async {
    _architectWidgetState?.onTouchBegan(pointer, x, y);
  }

  void onTouchEnded(int pointer, double x, double y) async {
    _architectWidgetState?.onTouchEnded(pointer, x, y);
  }

  void onTouchCancelled(int pointer, double x, double y) async {
    _architectWidgetState?.onTouchCancelled(pointer, x, y);
  }

  void onTouchMoved(int pointer, double x, double y) async {
    _architectWidgetState?.onTouchMoved(pointer, x, y);
  }
}
