...
namespace wikitude::sdk {
        ...
        enum WT_EXPORT_API ColorSpace {
            ...
            */
            ...
            /**
             * Represents a color space where image data is given by a single luminance channel where each pixel is represented by 8 bits. This image format provides no color data.
             * The data size is frame width * frame height.
             */
            Y8,
