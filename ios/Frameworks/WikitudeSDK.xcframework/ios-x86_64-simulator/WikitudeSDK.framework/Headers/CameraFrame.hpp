...
namespace wikitude::sdk {
    ...
    public:
        DepthCameraFrameMetadata(float horizontalFov_, sdk::Size<int> pixelSize_, unsigned int dataSize_, unsigned int confidenceDataSize_, DepthDataFormat depthDataFormat_, bool inverted_,
            std::int32_t timestampTimescale_);

        DepthCameraFrameMetadata(IntrinsicsCalibration intrinsicsCalibration_, sdk::Size<int> pixelSize_, unsigned int dataSize_, unsigned int confidenceDataSize_, DepthDataFormat depthDataFormat_,
            bool inverted_, std::int32_t timestampTimescale_);
    ...
    public:
        ...
        ColorCameraFrameMetadata(
            IntrinsicsCalibration intrinsicsCalibration_, sdk::Size<int> pixelSize_, CameraPosition cameraPosition_, ColorSpace frameColorSpace_, std::int32_t timestampTimescale_);
    ...
    public:
        ...
        CameraFrame(long id_, std::int64_t colorTimestamp_, ColorCameraFrameMetadata colorMetadata_, const std::vector<CameraFramePlane>& colorData_, std::int64_t depthTimestamp_,
            DepthCameraFrameMetadata depthMetadata_, const void* depthData_);
        CameraFrame(long id_, std::int64_t colorTimestamp_, ColorCameraFrameMetadata colorMetadata_, const std::vector<CameraFramePlane>& colorData_, std::int64_t depthTimestamp_,
            DepthCameraFrameMetadata depthMetadata_, const void* depthData_, const void* confidenceDepthData_);
        CameraFrame(long id_, std::int64_t colorTimestamp_, ColorCameraFrameMetadata colorMetadata_, const std::vector<CameraFramePlane>& colorData_, std::int64_t depthTimestamp_,
            DepthCameraFrameMetadata depthMetadata_, const void* depthData_, const Matrix4& pose_);
        CameraFrame(long id_, std::int64_t colorTimestamp_, ColorCameraFrameMetadata colorMetadata_, const std::vector<CameraFramePlane>& colorData_, std::int64_t depthTimestamp_,
            DepthCameraFrameMetadata depthMetadata_, const void* depthData_, const void* confidenceDepthData_, const Matrix4& pose_);

        CameraFrame(long id_, const std::string& deviceName_, long deviceId_, CameraType cameraType_, std::int64_t colorTimestamp_, ColorCameraFrameMetadata colorMetadata_,
            const std::vector<CameraFramePlane>& colorData_);
        CameraFrame(long id_, const std::string& deviceName_, long deviceId_, CameraType cameraType_, std::int64_t colorTimestamp_, ColorCameraFrameMetadata colorMetadata_,
            const std::vector<CameraFramePlane>& colorData_, const Matrix4& pose_);
        CameraFrame(long id_, const std::string& deviceName_, long deviceId_, CameraType cameraType_, std::int64_t colorTimestamp_, ColorCameraFrameMetadata colorMetadata_,
            const std::vector<CameraFramePlane>& colorData_, std::int64_t depthTimestamp_, DepthCameraFrameMetadata depthMetadata_, const void* depthData_, const void* confidenceDepthData_,
            const Matrix4& pose_);
        ...
        /** @brief Returns unique name of the device that produced this frame. Returned value is "Unknown" if no device name was provided during frame creation.
         */
        const std::string& getDeviceName() const;

        /** @brief Returns unique id of the device that produced this frame. Returned value is -1 if no device id was provided during frame creation.
         */
        long getDeviceId() const;

        /** @brief Returns type of this frame's camera.
         */
        ...
        /** @brief Returns a pointer to the confidence depth data, as it was passed through the constructor. When passed to the constructor, it may be nullptr to indicate the absence of confidence
         * depth data.
         */
