...
#include "ARBridgePluginModule.hpp"
...
namespace wikitude::sdk {
            ...
            public:
                 ...
                 */
                virtual void cameraFrameAvailable(ManagedCameraFrame& managedCameraFrame_) DEPRECATED_SINCE(9.13.0, "Use cameraFramesAvailable instead.");

                /**
                 * Will be called every time the Wikitude Engine receives multiple new camera frames from the platform camera.
                 *
                 * @param managedCameraFrames_ vector containing frame wrapper objects which include the frame data and some metadata about the frame
                 */
                ...
                ARBridgePluginModule* getARBridgePluginModule() const;
            ...
            protected:
                ...
                void setARBridgePluginModule(std::unique_ptr<ARBridgePluginModule> arBridgePluginModule_);
            ...
            private:
                ...
                std::unique_ptr<ARBridgePluginModule>           _arBridgeModule;
