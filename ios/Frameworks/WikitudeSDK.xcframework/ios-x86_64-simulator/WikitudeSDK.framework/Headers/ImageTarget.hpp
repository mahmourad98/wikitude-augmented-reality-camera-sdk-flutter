...
namespace wikitude::sdk {
    ...
    public:
        ...
        /** @brief Gets the physical height of the image target as it is defined in the .wtc or through the ImageTrackerConfiguration property set with
         * ImageTrackerConfiguration::setPhysicalTargetImageHeights()
         *
        ...
        virtual Vector3 getRotationTo(const ImageTarget& otherTarget_, bool backwardsCompatibilityEnabled_ = false) const = 0;
        ...
        virtual Vector3 getTranslationTo(const ImageTarget& otherTarget_, bool backwardsCompatibilityEnabled_ = false) const = 0;
